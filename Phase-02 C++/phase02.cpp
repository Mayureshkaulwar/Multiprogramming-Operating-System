    ...
    void MOS()
    {
        ...
        if (terminate)
        {
            ...
            case 6:
                ...
                break;
            case 7:
                fout << "TIME LIMIT EXCEEDED with OPERATION CODE ERROR\n";
                break;
            case 8:
                fout << "TIME LIMIT EXCEEDED with OPERAND ERROR\n";
                break;
            }
            fout << "job ID " << get_IC() << "\nIR " << fetched_IR << "\nTLC " << TLC << "\n LLC " << LLC << "\nValue of IC: " << get_IC() << "\nValue of IR: " << get_IR() << endl;
